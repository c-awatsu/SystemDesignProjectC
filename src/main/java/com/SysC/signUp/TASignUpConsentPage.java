...
public class TASignUpConsentPage extends AbstractSignUpPage{
	...
	public TASignUpConsentPage(@NonNull IModel<SignUp> signUpModel){
		...
		add(new AjaxLink<SignUp>("createAccount",signUpModel){
			...
			public void onClick(AjaxRequestTarget target) {
				getModelObject().setRole(ARSRoles.TA);
